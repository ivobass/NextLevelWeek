...
server.get("/search", (req, res) => {
        ...
        db.all(`SELECT * FROM places WHERE city = '${search}'`, function(err, rows) { // substituindo o  * por name conseguimos ver so o nome  no SQL passar uma string tem de colocar aspas simples '${search}'  
            if (err) {
