...
const db = new sqlite3.Database("../database/db.js")
...
`
    ...
    function afterInsertData(err) {
        ...
        consule.log("Cadastrado com sucesso")
        console.log("this") // quando tem o this nao pode funcionar numa arrow funcion  =>{  }
